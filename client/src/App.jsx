...
const AppRoutes = () => (
  <Routes>
    ...
    <Route path="/order-success"   element={<PrivateRoute roles={['visitor']}><OrderSuccessPage /></PrivateRoute>} />
    <Route path="/my-orders"       element={<PrivateRoute roles={['visitor']}><MyOrdersPage /></PrivateRoute>} />
